...
def main():
    # 1. Pastikan database siap dulu sebelum aplikasi mulai
    siapkan_folder_dan_file()
    
    print("\n========================================")
    print(" SELAMAT DATANG DI SISTEM KEUANGAN ")
    print("========================================")
    ...
    while True:
        ...
        if data_user is None:
            ...
            # Kalau loop menu selesai (user pilih logout), tanya mau keluar aplikasi gak?
